...
describe('LanguageSelector', () => {
  it('renders all language options', () => {
    render(<LanguageSelector currentLanguage="en-US" onLanguageChange={() => {}} />);
  ...
  it('shows current language as selected', () => {
    render(<LanguageSelector currentLanguage="pt-BR" onLanguageChange={() => {}} />);
    expect(screen.getByRole('combobox')).toHaveValue('pt-BR');
  });

  it('calls onLanguageChange when selection changes', async () => {
    const onLanguageChange = vi.fn();
    render(<LanguageSelector currentLanguage="en-US" onLanguageChange={onLanguageChange} />);
